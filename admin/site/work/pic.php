<?php
	...
	$wid = $_GET['wid']; if ($wid != "") { $_SESSION['sess_wid'] = $wid; } $sess_wid = $_SESSION['sess_wid'];
	$_SESSION['sess_padmin'] = "site/work/pic.php";

	// Page Content
	$pid = 4000;
	include("../../config/page.info.php");

	$sql = "select * from tb_work WHERE wid='$sess_wid'";
	...
	// CONSTANTS
	$upload_dir = "../../resources/work"; 	// The directory for the images to be saved in
...
<body>
	...
	<p id="nav">
		...
		<a href="update.php?wid=<?php echo $sess_wid;?>"><?php echo $rec[wtitle_en];?></a> &nbsp;&gt;&nbsp; 
	...
	<div id="content">
		...
		if (strlen($large_photo_exists) > 0 && strlen($thumb_photo_exists) > 0)	{
			...
			if ($resultw) {
				...
				if ($_SESSION['sess_wid'] == "") print "<meta http-equiv=\"refresh\"content=\"0; URL=update.php?wid=$wid\">";
			} else {
