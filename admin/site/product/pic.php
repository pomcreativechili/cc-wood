<?php
	...
	$_SESSION['sess_padmin'] = "site/product/pic.php";
	...
	$sql = "select * from tb_product WHERE pdid='$sess_pdid' AND pid='$sess_pid' AND cid='$sess_cid'";
...
<body>
	...
	<p id="nav">
		...
		<a href="update.php?pid=<?php echo $sess_pid;?>&amp;cid=<?php echo $sess_cid;?>&amp;pdid=<?php echo $sess_pdid;?>"><?php echo $rec[pdtitle_en];?></a> &nbsp;&gt;&nbsp; 
	...
	<div id="content">
		...
		if (strlen($large_photo_exists) > 0 && strlen($thumb_photo_exists) > 0)	{
			...
			if ($resultpd) {
				...
				if ($_SESSION['sess_pdid'] == "" and $_SESSION['sess_cid'] == "" and $_SESSION['sess_pid'] == "") print "<meta http-equiv=\"refresh\"content=\"0; URL=update.php?pid=$pid&cid=$cid&pdid=$pdid\">";
			} else {
		...
		<?php } ?>
			...
			<table cellpadding="0" cellspacing="0" class="contentinfo">
				...
				<tr>
					<td>&nbsp;</td>
					<td class="tip">
					^ 700 Pixels for maximum of width size (122 x 122 Pixels for Thumbnail size)<br />
