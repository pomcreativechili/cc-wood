<?php
	...
	$htype = $_GET['htype']; if ($htype != "") { $_SESSION['sess_htype'] = $htype; } $sess_htype = $_SESSION['sess_htype'];
	if ($_SESSION['sess_hid'] == "") { $_SESSION['sess_hid'] = date("ymdHis"); } $sess_hid = $_SESSION['sess_hid'];
	$_SESSION['sess_padmin'] = "site/home/add.php";
	
	$chk = $_POST['chk'];
	if ($chk == "1")	{
		$hposted = date("Y-m-d H:i:s");
		...
		$sqlh = "INSERT INTO tb_home VALUES ('$sess_hid','$sess_htype','$htitle_en','$htitle_th','$hdetail_en','$hdetail_th','$hurl_en','$hurl_th','','$hposted','0','0')";
		$resulth = mysql_query($sqlh,$dgz);
		if ($resulth) { header("Location:add.php"); }
	...
	if (!isset($_SESSION['random_key']) || strlen($_SESSION['random_key'])==0){
		$_SESSION['random_key'] = $sess_hid; //assign the timestamp to the session variable
		$_SESSION['user_file_ext']= "";
	}
	
	// CONSTANTS
	$upload_dir = "../../resources/home"; 	// The directory for the images to be saved in
	$upload_path = $upload_dir."/";				// The path to where the image will be saved
	$large_image_prefix = "";			// The prefix name to large image
	$thumb_image_prefix = $hfile;			// The prefix name to the thumb image
	...
	$thumb_width = "124";						// Width of thumbnail image
	$thumb_height = "124";						// Height of thumbnail image
...
<body>
	...
	<p id="nav">
        <a href="index.php?htype=<?php echo $sess_htype;?>">All <?php echo $htext;?>s</a> &nbsp;&gt;&nbsp; 
		<strong>Post new <?php echo $htext;?></strong>
	</p>
	...
	<div id="content">
		...
		if (strlen($large_photo_exists) > 0 && strlen($thumb_photo_exists) > 0)	{
			...
			$sqlh = "UPDATE tb_home SET hpic='$thname' WHERE hid='$sess_hid' AND htype='$sess_htype'";
			$resulth = mysql_query($sqlh,$dgz);
			if ($resulth) {
				...
				unset($_SESSION['sess_htype']);
				unset($_SESSION['sess_hid']);
				
				if ($_SESSION['sess_hid'] == "" and $_SESSION['sess_htype'] == "") print "<meta http-equiv=\"refresh\"content=\"0; URL=index.php?htype=$htype\">";
			} else {
		...
		<?php } ?>
			...
			function check()	{
				if (document.photo.htitle_en.value == "")	{
					alert("Please fill in title");
					document.photo.htitle_en.focus();
					return false;
				}
				if (document.photo.hdetail_en.value == "")	{
					alert("Please fill in detail / info");
					document.photo.hdetail_en.focus();
					return false;
				}
				<?php if ($htype == "1") { ?>
				if (document.photo.hurl_en.value == "")	{
					alert("Please fill in URL");
					document.photo.hurl_en.focus();
					return false;
				}
				<?php } ?>
				if (document.photo.htitle_th.value == "")	{
					alert("Please fill in title");
					document.photo.htitle_th.focus();
					return false;
				}
				if (document.photo.hdetail_th.value == "")	{
					alert("Please fill in detail / info");
					document.photo.hdetail_th.focus();
					return false;
				}
				<?php if ($htype == "1") { ?>
				if (document.photo.hurl_th.value == "")	{
					alert("Please fill in URL");
					document.photo.hurl_th.focus();
					return false;
				}
				<?php } ?>
            ...
            <h3><img src="../../images/tools/add.png" alt="" />&nbsp; Post new <?php echo $htext;?></h3>	
			<table cellpadding="0" cellspacing="0" class="contentinfo">
                ...
                <tr>
                    ...
                    <td style="padding-top:25px; width:740px;"><input name="htitle_en" type="text" class="box" value="" size="" style="width:700px;" /></td>
                </tr>
                <tr>
                    <td>Detail / Info :</td>
                    <td><textarea name="hdetail_en" class="box" rows="4" style="width:700px;"></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td><input name="hurl_en" type="text" class="box" value="" size="" style="width:700px;" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td style="padding-top:25px; width:160px;">Title :</td>
                    <td style="padding-top:25px; width:740px;"><input name="htitle_th" type="text" class="box" value="" size="" style="width:700px;" /></td>
                </tr>
                <tr>
                    <td>Detail / Info :</td>
                    <td><textarea name="hdetail_th" class="box" rows="4" style="width:700px;"></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td class="tip">^ Any copied text (from Microsoftword or other program) MUST be pasted into "Micosoft Note Pad application" first, then re-copied into the text area editor below. This is to stop uni-code (which is in Word) getting into the system.</td>
                ...
                <tr>
                    <td><?php echo $hurltext;?></td>
                    <td><input name="hurl_th" type="text" class="box" value="" size="" style="width:700px;" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td class="tip"><?php echo $hurltip;?></td>
