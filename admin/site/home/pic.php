<?php
	...
	$htype = $_GET['htype']; if ($htype != "") $_SESSION['sess_htype'] = $htype;
	$sess_htype = $_SESSION['sess_htype'];
	$hid = $_GET['hid']; if ($hid != "") $_SESSION['sess_hid'] = $hid;
	$sess_hid = $_SESSION['sess_hid'];
	$_SESSION['sess_padmin'] = "site/home/pic.php";

	$sql = "select * from tb_home WHERE hid='$sess_hid' AND htype='$sess_htype'";
...
<body>
	...
	<p id="nav">
		...
		<a href="update.php?htype=<?php echo $sess_htype;?>&amp;hid=<?php echo $sess_hid;?>"><?php echo $rec[htitle_en];?></a> &nbsp;&gt;&nbsp; 
	...
	<div id="content">
		...
		if (strlen($large_photo_exists) > 0 && strlen($thumb_photo_exists) > 0)	{
			...
			if ($resulth) {
				...
				if ($_SESSION['sess_hid'] == "" and $_SESSION['sess_htype'] == "") print "<meta http-equiv=\"refresh\"content=\"0; URL=update.php?htype=$htype&hid=$hid\">";
			} else {
			...
			<table cellpadding="0" cellspacing="0" id="contentform"> 
				<tr>
                	<td class="tip">
